  ...
  return (
    <div className="joinOuterContainer">
     ...
     <div class="copyright_footer">
       © 2021 Pocket Chat &ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;<a target="_blank" href="https://pocket-chat-doc.vercel.app/">Documentation</a> | <a target="_blank" href="https://pocket-chat.betteruptime.com/">Status</a>
     </div>
   </div>
 </div>
);
